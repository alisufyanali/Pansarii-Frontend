...
const reasons: Reason[] = [
  {
    ...
    desc: "Rooted in generations of herbal expertise, we carry forward authentic Unani & Ayurvedic recipes that have stood the test of time.",
    position: "top-left",
  },
  {
    Icon: FaLeaf,
    title: "100% Herbal & Natural",
    desc: "Every product is crafted from pure, plant-based ingredients — no artificial colours, flavours, or synthetic additives.",
    position: "top-right",
  },
  {
    Icon: FaCertificate,
    title: "Certified & Quality Assured",
    desc: "Our products meet strict quality standards and are prepared under hygienic, controlled conditions you can trust.",
    position: "mid-left",
  },
  {
    Icon: FaFlask,
    title: "Clinically Validated Formulas",
    desc: "Traditional remedies backed by modern research — each formula is carefully tested for safety, potency, and effectiveness.",
    position: "mid-right",
  },
  {
    Icon: FaBan,
    title: "Chemical Free",
    desc: "Zero harmful chemicals, preservatives, or fillers. Just nature's finest ingredients in every bottle, pouch, and pack.",
    position: "bot-left",
  },
  {
    Icon: FaGlobe,
    title: "Global Presence & Trust",
    desc: "Thousands of satisfied customers across Pakistan and beyond trust PansariInn for genuine herbal wellness every day.",
    position: "bot-right",
  },
];
