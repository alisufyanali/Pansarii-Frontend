...
function ShopContent({
  ...
  // NOTE: No early return on isLoading — SearchFilterBar must stay mounted at
  // all times. Unmounting it on every fetch cycle resets its refs/state and
  // re-fires the debounce, which re-triggers the fetch in an infinite loop.
  ...
  return (
    ...
    */
    <div className="mx-auto max-w-screen-2xl px-3 sm:px-4 lg:px-6 2xl:px-10 py-4 sm:py-6">
      ...
      {/* Results Info — skeleton while loading */}
      <div className="my-4 sm:my-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        {isLoading ? (
          <>
            <div className="space-y-1 sm:space-y-2">
      ...
      {/* Product Grid — skeleton while loading, real grid when ready */}
      {isLoading ? (
