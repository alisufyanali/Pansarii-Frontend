...
export default function ProductDetailsModal({ product, onClose }: ProductDetailsModalProps) {
  ...
  }, [product.id, isInWishlist, isLoggedIn]);
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 md:p-0">
        ...
        >
          ...
          <button
            ...
            className={`absolute top-2 left-2 z-20 w-7 h-7 md:w-9 md:h-9 flex items-center justify-center rounded-full shadow-lg transition-colors ${
              isWishlisted 
          ...
          >
            {isWishlisted ? (
              <FaHeart className="w-3.5 h-3.5 md:w-4 md:h-4 text-red-500" />
            ) : (
          ...
          <div className="flex flex-row min-h-full md:min-h-0 overflow-y-auto max-h-[95vh]">
            ...
            <div className="w-[40%] md:w-2/5 p-2 md:p-6 border-r border-gray-100 flex-shrink-0 overflow-y-auto">
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-50">
                ...
                {product.oldPrice && (
                  <div className="absolute bottom-2 left-2 z-10 px-1.5 py-0.5 md:px-2 md:py-1 bg-red-500 text-white rounded-full text-[8px] md:text-xs font-bold">
